...
```bash
sudo apt install ./HackMan3D-Control-Deck-Linux-ARCHITECTURE-1.5.5-r5.deb
```
...
```bash
chmod +x HackMan3D-Control-Deck-Linux-ARCHITECTURE-1.5.5-r5.AppImage
./HackMan3D-Control-Deck-Linux-ARCHITECTURE-1.5.5-r5.AppImage
```
